...
def parse_args():
    ...
    parser.add_argument("-A ", "--analysis",
                        choices=[
                            ...
                            'overwrite'],
                        default=None,
                        help=" Specify analysis type to determine if raw data will"
                        " be collected or analyzed. If already analyzed, "
                        "specify if it should read or overwrite current "
                        "analysis. Options include\n"
                        "(collect, read, overwrite, None(default)).")
