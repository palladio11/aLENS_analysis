# -*- coding: utf-8 -*-
"""Tests for `alens_analysis` package."""

import random

import pytest

from alens_analysis import alens_analysis
...
def test_sum_numbers(generate_numbers):
    ...
    our_result = alens_analysis.sum_numbers(generate_numbers)
...
def test_max_number(generate_numbers):
    ...
    our_result = alens_analysis.max_number(generate_numbers)
