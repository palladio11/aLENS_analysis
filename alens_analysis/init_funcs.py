...
from .read_func import get_file_number
...
def make_last_step_new_init(args):
    ...
    if isinstance(last_syl_file, zipfile.Path):
        ...
        copy(last_syl_file, root_dir / 'TubuleInitial{args.string_append}.dat')
        copy(last_prot_file, root_dir /
             'ProteinInitial{args.string_append}.dat')
